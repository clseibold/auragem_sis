...
func HandleStarWars(s sis.ServerHandle) {
	...
	s.AddRoute("/starwars2/", func(request sis.Request) {
		...
		request.SetScrollMetadataResponse(sis.ScrollMetadata{Author: "Christian Lee Seibold", PublishDate: publishDate, UpdateDate: updateDate, Language: "en", Abstract: "# Star Wars Database\n"})
...
`)
	...
	s.AddRoute("/starwars2/timeline/shows", func(request sis.Request) {
		...
		request.SetScrollMetadataResponse(sis.ScrollMetadata{Author: "Christian Lee Seibold", PublishDate: publishDate, UpdateDate: lastUpdate, Language: "en", Abstract: "# Star Wars Database: TV Shows (Timeline)\n"})
		if request.ScrollMetadataRequested {
			request.SendAbstract("")
			return
		}
...
`, builder.String()))
	...
	s.AddRoute("/starwars2/timeline/comics", func(request sis.Request) {
		...
		request.SetScrollMetadataResponse(sis.ScrollMetadata{Author: "Christian Lee Seibold", PublishDate: publishDate, UpdateDate: lastUpdate, Language: "en", Abstract: "# Star Wars Database: Comics (Timeline)\n"})
		if request.ScrollMetadataRequested {
			request.SendAbstract("")
			return
		}
...
`, builder.String()))
	...
	s.AddRoute("/starwars2/publication/comics", func(request sis.Request) {
		...
		request.SetScrollMetadataResponse(sis.ScrollMetadata{Author: "Christian Lee Seibold", PublishDate: publishDate, UpdateDate: lastUpdate, Language: "en", Abstract: "# Star Wars Database: Comics (Publication)\n"})
		if request.ScrollMetadataRequested {
			request.SendAbstract("")
			return
		}
...
`, builder.String()))
	...
	s.AddRoute("/starwars2/timeline/comics/tpbs", func(request sis.Request) {
		...
		request.SetScrollMetadataResponse(sis.ScrollMetadata{Author: "Christian Lee Seibold", PublishDate: publishDate, UpdateDate: lastUpdate, Language: "en", Abstract: "# Star Wars Database: Comic TPBs (Timeline)\n"})
		if request.ScrollMetadataRequested {
			request.SendAbstract("")
			return
		}
...
`, builder.String()))
	...
	s.AddRoute("/starwars2/publication/comics/tpbs", func(request sis.Request) {
		...
		request.SetScrollMetadataResponse(sis.ScrollMetadata{Author: "Christian Lee Seibold", PublishDate: publishDate, UpdateDate: lastUpdate, Language: "en", Abstract: "# Star Wars Database: Comic TPBs (Publication)\n"})
		if request.ScrollMetadataRequested {
			request.SendAbstract("")
			return
		}
...
`, builder.String()))
	...
	s.AddRoute("/starwars2/timeline/comics/issues", func(request sis.Request) {
		...
		request.SetScrollMetadataResponse(sis.ScrollMetadata{Author: "Christian Lee Seibold", PublishDate: publishDate, UpdateDate: lastUpdate, Language: "en", Abstract: "# Star Wars Database: Comic Issues (Timeline)\n"})
		if request.ScrollMetadataRequested {
			request.SendAbstract("")
			return
		}
...
`, builder.String()))
	...
	s.AddRoute("/starwars2/publication/comics/issues", func(request sis.Request) {
		...
		request.SetScrollMetadataResponse(sis.ScrollMetadata{Author: "Christian Lee Seibold", PublishDate: publishDate, UpdateDate: lastUpdate, Language: "en", Abstract: "# Star Wars Database: Comic Issues (Publication)\n"})
		if request.ScrollMetadataRequested {
			request.SendAbstract("")
			return
		}
...
`, builder.String()))
	...
	s.AddRoute("/starwars2/timeline/bookseries", func(request sis.Request) {
		...
		request.SetScrollMetadataResponse(sis.ScrollMetadata{Author: "Christian Lee Seibold", PublishDate: publishDate, UpdateDate: lastUpdate, Language: "en", Abstract: "# Star Wars Database: Book Series (Timeline)\n"})
		if request.ScrollMetadataRequested {
			request.SendAbstract("")
			return
		}
...
`, builder.String()))
	...
	s.AddRoute("/starwars2/timeline/books", func(request sis.Request) {
		...
		request.SetScrollMetadataResponse(sis.ScrollMetadata{Author: "Christian Lee Seibold", PublishDate: publishDate, UpdateDate: lastUpdate, Language: "en", Abstract: "# Star Wars Database: Books (Timeline)\n"})
		if request.ScrollMetadataRequested {
			request.SendAbstract("")
			return
		}
...
func handleMovies(request sis.Request, conn *sql.DB, timeline bool) {
	...
	request.SetScrollMetadataResponse(sis.ScrollMetadata{Author: "Christian Lee Seibold", PublishDate: publishDate, UpdateDate: lastUpdate, Language: "en", Abstract: "# Star Wars Database: Movies\n"})
	if request.ScrollMetadataRequested {
		request.SendAbstract("")
		return
	}
...
func handleMoviesCSV(request sis.Request, conn *sql.DB, timeline bool) {
	movies, lastUpdate := GetMovies(conn, timeline)
	request.SetScrollMetadataResponse(sis.ScrollMetadata{Author: "Christian Lee Seibold", PublishDate: publishDate, UpdateDate: lastUpdate, Language: "en", Abstract: "# Star Wars Database: Movies CSV\n"})
	if request.ScrollMetadataRequested {
